...
export let villages: Village[] = [
  ...
  },
  {
    ...
    susceptibility_base_score: 0.76,
    current_rainfall_24h_mm: 148.0,
    rainfall_7d_total_mm: 520.2,
    rainfall_72h_mm: 290.5,
...
export let recentLandslides: RecentLandslide[] = [
  {
    ...
    location_name: 'Laitkynsew Ridge Valley Km 4',
    state_id: 'state_meghalaya',
    state_name: 'Meghalaya',
    district_id: 'dist_ekh',
    district_name: 'East Khasi Hills',
    ...
    road_affected: 'Sohra - Laitkynsew Ridge Link Road (Blocked)',
...
export let alerts: Alert[] = [
  {
    id: 'ALT-NER-0941',
    title: 'RED ALERT: Critical Slope Failure Warning — Mawsynram & Laitkynsew',
  ...
  },
  {
    ...
    description: 'Piezometer reading surged to 52.8 kPa pore pressure combined with 198mm rainfall. Risk of catastrophic rock detachment along Laitkynsew ridge.',
    category: 'CRITICAL_EMERGENCY',
    state_id: 'state_meghalaya',
    state_name: 'Meghalaya',
    district_id: 'dist_ekh',
    ...
    contributing_factors: [
      'Slope Angle: 44.0° (High Gradient)',
      '24h Precipitation: 148.0 mm',
      'Pore Water Pressure: 42.5 kPa',
      'Displacement Velocity: 0.28°/day'
    ],
    recommended_actions: [
...
export function simulateHeavyRainCloudburst(targetVillageIds?: string[]) {
  const targets = targetVillageIds && targetVillageIds.length > 0 
    ? targetVillageIds 
    : ['vil_sohra_town', 'vil_laitkynsew', 'vil_mawsynram_central', 'vil_tyrna', 'vil_dawki_ghat', 'vil_haflong_scarp'];
